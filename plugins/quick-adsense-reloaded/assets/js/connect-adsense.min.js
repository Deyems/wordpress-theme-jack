;(function($){
    ...
    $( document ).on( 'click', '#report_type,#report_period,#quads-adsense', function(){
...
if(report_type == 'top_device_type') {
    ...
    var datasets =[];
    var dates_array = [];
    var data_array_desktop = [];
    var data_array_tablet = [];
    var data_array_mobile = [];
    for (index = 0; index < data_length; ++index) {
        ...
        if (response[index][1] == 'Desktop') {
            data_array_desktop.push(response[index][2]);
        } else if (response[index][1] == 'Tablet') {
            data_array_tablet.push(response[index][2]);
        } else if (response[index][1] == 'HighEndMobile') {
            data_array_mobile.push(response[index][2]);
        }
    }
    datasets =[{
        label: 'Desktop',
